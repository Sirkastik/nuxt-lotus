<template>
  <div class="grid place-content-center text-gray-700">
    ...
    <div class="text-center cursor-pointer text-blue-700 hover:animate-bounce hover:font-medium py-2" @click="$router.push('/')">
      Go home
    </div>
  </div>
</template>
